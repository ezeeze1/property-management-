      ...
      <div className="bg-white text-slate-900 rounded-2xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl relative border border-slate-300 printable-receipt">
        ...
        <div className="flex justify-between items-center pb-4 mb-6 border-b border-slate-200 print:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onClose}
              className="bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold px-3 py-1.5 rounded-lg text-xs flex items-center gap-1.5 transition-colors"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="pt-6 border-t border-slate-200 flex justify-between items-end text-xs">
            ...
            <div className="text-center">
              ...
              <div className="text-[10px] font-bold text-slate-700 mt-1 uppercase tracking-wider">Authorized Management Signatory</div>
            </div>
          </div>

          {/* Bottom Close Button Bar (Hidden during print) */}
          <div className="pt-4 border-t border-slate-200 flex justify-end gap-3 print:hidden">
            <button
              onClick={onClose}
              className="bg-slate-900 hover:bg-slate-800 text-amber-400 font-bold px-5 py-2.5 rounded-xl text-xs flex items-center gap-2 shadow-md transition-all"
            >
              <X className="w-4 h-4" /> Close Receipt
            </button>
          </div>
